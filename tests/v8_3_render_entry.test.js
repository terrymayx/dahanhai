...
const tuning=fs.readFileSync('js/v8/35_combat_tuning.js','utf8');
...
assert(battle.includes('startPlayerSalvo'),'V8.3 salvo machinery must remain available');
assert(/PLAYER_SALVO_COUNT\s*=\s*2/.test(tuning),'active tuning must reduce the salvo to two shells');

...
assert(html.includes('大航海时代 V8.5 · 船体损伤与进水'),'page title must identify current V8.5 entry');
for(const f of ['00_v8_base.js','10_ship_grid.js','20_projectiles.js','30_battle.js','35_combat_tuning.js','40_render.js','50_input_loop.js']){
  assert(html.includes(`js/v8/${f}?v=8.5.0`),`${f} must remain loaded by V8.5 entry`);
}

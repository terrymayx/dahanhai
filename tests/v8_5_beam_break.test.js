...
assert(state.fx.some(f=>f.k==='structureRupture'),'V8.5 must add local structure rupture feedback for beam-driven detachment');
assert.strictEqual(state.shake,0,'beam rupture must not restore camera shake');
console.log('V8.5 beam break tests passed');

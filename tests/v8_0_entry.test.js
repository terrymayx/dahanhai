...
assert(/V8\.\d/.test(index),'index title must identify a V8 release');
...
assert(!index.includes('21_boarding_update.js'),'V8 must not load legacy boarding system');
assert(!index.includes('31_v73_proximity_boarding.js'),'V8 must not load V7 proximity wrapper');
...
console.log('V8 entry tests passed');

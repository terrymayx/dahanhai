(function(root){
  ...
  function drawHudOverlay(ctx,state){
    ...
    ctx.fillStyle='rgba(7,37,53,.76)';ctx.beginPath();ctx.roundRect(310,C.H-68,1300,42,12);ctx.fill();ctx.font='700 19px "Microsoft YaHei",sans-serif';ctx.fillStyle='#e9f8ff';ctx.fillText('底层仍是独立格耐久与破甲穿透 · 视觉不显示网格 · 无镜头/船体受击抖动 · 无进水',960,C.H-47);
  }
